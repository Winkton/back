...
@router.post("/qna", summary="Qna 글 생성", response_model=qaListResponse)
...
@router.get("/qna", summary="Qna 글 불러오기", response_model=qaListResponse)
async def read_item():
    """
...
@router.put("/qna/{postID}", summary="Qna 글 업데이트", response_model=qaListResponse)
